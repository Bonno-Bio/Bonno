...
import { PLAN_MATRIX, PREMIUM_PRICE_MONTHLY, PREMIUM_PRICE_ANNUAL } from "@/lib/plans";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16 pt-10 text-center md:pt-20">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link href={start} className="btn-primary px-6 py-3 text-base">Start free — no card required <ArrowRight size={18} /></Link>
          {auth.mode === "local" && (
        ...
        <p className="mt-3 text-xs text-slate-400">Free forever · Upgrade securely with PayPal or Visa / Mastercard</p>
      </section>
      ...
      <section id="pricing" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mx-auto mt-10 grid max-w-4xl gap-4 md:grid-cols-2">
          ...
          <div className="card border-emerald-500 p-6 ring-2 ring-emerald-500">
            ...
            <Link href={start} className="btn-primary mt-6 w-full">Start free</Link>
          </div>
        </div>
