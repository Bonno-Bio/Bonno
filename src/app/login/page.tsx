    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="card p-6">
          ...
          <p className="mb-4 text-sm text-slate-500">{mode === "signin" ? "Sign in to your business dashboard." : mode === "signup" ? "Free forever · 14-day Premium trial included." : "We'll email you a reset link."}</p>
